                ...
                if (strExcelFilePath != null && strExcelFilePath != "")
                {
                    ...
                    { // COMMENT ON 21 JULY 2022
                      //  workbook.SaveAs(strExcelFilePath + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue, misValue, misValue, misValue, Excel.XlSaveAsAccessMode.xlExclusive, misValue, misValue, misValue, misValue, misValue);
                        ...
                        workbook.SaveAs("D:\\XLSTEMP\\" + BatchDetail.BatchNo + ".xls", Excel.XlFileFormat.xlWorkbookNormal, misValue, misValue, misValue, misValue, Excel.XlSaveAsAccessMode.xlExclusive, misValue, misValue, misValue, misValue, misValue);
                        ...
                        System.IO.File.Copy("D:\\XLSTEMP\\" + BatchDetail.BatchNo + ".xls", strExcelFilePath + ".xls", true);
                    }
                    catch (Exception ex)
                    {
